        ...
        <div class="title-block">
          ...
          <div class="right-area">
            <ul class="list-unstyled panel-layout btn-box-01">
              ...
              <li>
                <a href="{{ route('books.create') }}" class="btn btn-primary"><small><i class="fa fa-edit"></i></small> Thêm mới</a>
              </li>
            </ul>
            <div class="toggel-box">
              <div class="collapse toggel-btn-fade" id="search_advanced">
                <form method="GET" action="{{ route('books.index') }}" role="form" class="clearfix">
                  ...
                  <div class="form-group clearfix text-right">
                    ...
                    <a  class="btn btn-default" href="{{ route('books.index') }}">Reset</a>
