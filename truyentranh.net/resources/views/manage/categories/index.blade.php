...
@section('content')
  <div id="main">
    ...
    <div class="col-xs-12">
        ...
        <div class="title-block">
          ...
          <div class="right-area">
            <ul class="list-unstyled panel-layout btn-box-01">
              ...
              <li>
                <a href="{{ route('categories.create') }}" class="btn btn-primary"><small><i class="fa fa-edit"></i></small> Thêm mới</a>
              </li>
            </ul>
            <div class="toggel-box">
              <div class="collapse toggel-btn-fade" id="search_advanced">
                <form method="GET" action="{{ route('categories.index') }}" role="form" class="clearfix">
                  ...
                  <div class="form-group clearfix text-right">
                    ...
                    <a  class="btn btn-default" href="{{ route('categories.index') }}">Reset</a>
      ...
      <form id="admin-form" method="POST" action="{{ route('categories.batch') }}" role="form" class="clearfix">
        {{ csrf_field() }}
        <div class="col-xs-12">
            ...
            @if(count($records) > 0)
              @foreach($records as $record)
                <tr>
                  ...
                  <td>
                    <a href="{{ route('categories.edit',$record->id) }}"><i class="fa fa-edit" data-toggle="tooltip" data-placement="top" title="Sửa"></i></a>
                  </td>
                  <td><a href="{{ route('categories.delete',$record->id) }}" onclick="return confirm('Bạn thật sự muốn xóa?');"><i class="fa fa-trash-o" data-toggle="tooltip" data-placement="top" title="Xóa"></i></a></td>
                </tr>
              @endforeach
            @endif
            </tbody>
