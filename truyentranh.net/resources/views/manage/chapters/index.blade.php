...
@section('content')
  <div id="main">
    ...
    <div class="col-xs-12">
          ...
          <div class="right-area">
            ...
            <div class="toggel-box">
              <div class="collapse toggel-btn-fade" id="search_advanced">
                <form method="GET" action="{{ route('chapters.index') }}" role="form" class="clearfix">
                  ...
                  <div class="form-group clearfix text-right">
                    ...
                    <a  class="btn btn-default" href="{{ route('chapters.index') }}">Reset</a>
      ...
      <form id="admin-form" method="POST" action="{{ route('chapters.batch') }}" role="form" class="clearfix">
        {{ csrf_field() }}
        <div class="col-xs-12">
