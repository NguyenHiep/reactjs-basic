...
<head>
  ...
  <meta property="og:url" content="@yield('seo_base_url')" />
  ...
  <link href="{{ asset('css/app.css?v='.VERSION_CSS) }}" rel="stylesheet">
...
<script src="{{ asset('assets/frontend/plugins/jscookie/src/js.cookie.js') }}"></script>
<script src='https://www.google.com/recaptcha/api.js?hl=vi'></script>
<script src="{{ asset('assets/frontend/main.js?v='.VERSION_JS) }}"></script>
@stack('scripts')
</body>
</html>
